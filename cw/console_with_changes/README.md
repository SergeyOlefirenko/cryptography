...
- Replay attack protection via timestamps and message counters.
- Skipped message keys for out-of-order message handling.
- Zeroization of keys after use for improved memory security.
- Automatic generation of long-term Ed25519 keys.
- Ephemeral X25519 keys signed for authenticated Diffie-Hellman exchange.
- Root and chain keys derived using HKDF to guarantee forward secrecy.
